...
project = "poignant-porcupine-domain"
...
if os.environ.get("READTHEDOCS") == "True":
    ...
    PACKAGE_ROOT = PROJECT_ROOT / "libs" / "poignant-porcupine-domain" / "src" / "poignant_porcupine_domain"
    ...
    def run_apidoc(_):
        ...
        apidoc.main(
            [
                ...
                "--separate",
                "-o",
                str(PROJECT_ROOT / "libs" / "poignant-porcupine-domain" / "docs" / "reference"),
                str(PACKAGE_ROOT),
            ]
        )
